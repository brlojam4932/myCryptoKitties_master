...
async function totalCats() {
  var cats = await contract.methods.totalSupply().call();
...
async function kittyByOwner() {
  ...
  res = await contract.methods.tokensOfOwner(owner).call();
  //console.log(res); 
...
async function breed() {
  let kitty = await contract.methods.Breeding(1, 2).send({from: owner});
...
async function singleKitty() {
  ...
  let kitty = await contract.methods.getKitty(1).call();
  //console.log( kitty);
}
